...
schema and its principal, and does nothing unless `SYNC_MGMT_DB_PASSWORD` is set in the
environment. On a central database that already exists, run its statements by hand once;
