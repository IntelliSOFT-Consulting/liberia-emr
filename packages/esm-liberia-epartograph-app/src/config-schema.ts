...
export const configSchema = {
  ...
  concepts: {
    ...
    systolicBloodPressureUuid: { _type: Type.ConceptUuid, _default: '17b1204b-ce88-4a0d-9c2f-6ebcc73b219f' },
    diastolicBloodPressureUuid: { _type: Type.ConceptUuid, _default: 'a7367960-91f3-4bba-875b-e7bdfa67f66d' },
